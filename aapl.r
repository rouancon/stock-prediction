...
#Read in data sets
library(readxl)
train_data_full <- read_excel("Documents/GitHub/stock-prediction/prices-split-adjusted.xlsx", sheet = "AAPL-train")
val_data_full <- read_excel("Documents/GitHub/stock-prediction/prices-split-adjusted.xlsx", sheet = "AAPL-val")
test_data_full <- read_excel("Documents/GitHub/stock-prediction/prices-split-adjusted.xlsx", sheet = "AAPL-model")

#initial plots
plot(train_data_full$open+val_data_full$open+test_data_full$open, type="l", col="red", xlab="Time (day)", ylab="Price ($)", main="Apple Pricing Data")
...
plot(train_data_full$volume+val_data_full$volume+test_data_full$volume, type="l", col="red", xlab="Time (day)", ylab="Volume (# Shares)", main="Apple Volume Data")
