...
#Read in data sets
library(readxl)
train_data_full <- read_excel("prices-split-adjusted.xlsx", sheet = "XOM-train")
val_data_full <- read_excel("prices-split-adjusted.xlsx", sheet = "XOM-val")
test_data_full <- read_excel("prices-split-adjusted.xlsx", sheet = "XOM-model")
