...
#initial plots
plot(train_data_full$open+val_data_full$open+test_data_full$open, type="l", col="red", xlab="Time (day)", ylab="Price ($)", main="Google Pricing Data")
...
plot(train_data_full$volume+val_data_full$volume+test_data_full$volume, type="l", col="red", xlab="Time (day)", ylab="Volume (# Shares)", main="Google Volume Data")
